                            ...
                            <nav className="main-nav-wrapper">
                                <div className="main-nav">
                                    <ul id="main-nav" className="nav nav-pills">
                                        ...
                                        <li className="menu-item nav-item menu-item-has-children dropdown current-menu-item"><Link to="/manga_reviews" className="dropdown-text nav-link"><i className="fa fa-angle-down btn-open-dropdown"></i>Manga Reviews</Link>
